...
const UpdateUser = () => {
 ...
 if(userData===null)
 {
  return <p className='text-center my-4 text-4xl font-bold text-gray-300'></p>
 }
  
  return (
    <div className='min-h-screen bg-gray-100 py-10' >

      <div className="max-w-md mx-auto bg-white border border-gray-200 rounded-xl shadow-2xs">
        {/* Sign In */}
            ...
            <div className="grid gap-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <input type="text" id="name"
                    ...
                    className="py-2.5 sm:py-3 px-4 block w-full bg-white border-gray-200 rounded-lg sm:text-sm text-gray-800 placeholder:text-gray-500 focus:border-blue-700 focus:ring-blue-700 disabled:opacity-50 disabled:pointer-events-none" aria-describedby="name-error" />
              ...
              <div>
                ...
                </div>
                {
                  ...
                  (<p className="text-xs text-red-600 mt-2" id="name-error">{signupForm.errors.email}</p>)
                }
              </div>
              {/* End Form Group */}
              ...
              <div>
                ...
                </div>
                {
                  ...
                  (<p className="text-xs text-red-600 mt-2" id="name-error">{signupForm.errors.password}</p>)
                }
              </div>
              {/* End Form Group */}
              ...
              <div>
                ...
                </div>
                {
                  ...
                  (<p className="text-xs text-red-600 mt-2" id="name-error">{signupForm.errors.confirmPassword}</p>)
                }
              </div>
              {/* End Form Group */}
              ...
              <div className="flex items-center">
                ...
                <div className="ms-3">
                  <label htmlFor="checkbox" className="text-sm text-gray-800">
                    I accept the <a className="text-blue-500 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium" href="#">Terms and Conditions</a>
                  </label>
                </div>
              </div>
              {/* End Checkbox */}
